...
import com.wtm.library.bitmap.core.BitmapCache;
import com.wtm.library.bitmap.download.DefaultDownloader;
import com.wtm.library.bitmap.download.Downloader;
import com.wtm.library.cache.FileNameGenerator;
import com.wtm.library.task.Priority;
...
public class BitmapGlobalConfig {
	...
	public synchronized static BitmapGlobalConfig getInstance(Context context,
		...
		if (TextUtils.isEmpty(diskCachePath)) {
			diskCachePath = OtherUtils.getDiskCacheDir(context, "wBitmapCache");
		}
